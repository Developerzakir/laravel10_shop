...
<link rel="icon" href="images/1684590428.jpg" type="image/gif">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container-fluid">
          <a class="navbar-brand" href="https://dailybazaar24.com/checkout#"><img src="./Checkout - Dailybazaar24.com_files/1686063922.jpg" alt=""></a>
	...
	<div class="container">
      ...
      @csrf --}}
		...
		<div class="col-sm-12 col-md-12 col-lg-6">
			<div class="card">
				<div class="card-body checkotu-custom-from">
					<p>অর্ডারটি কনফার্ম করতে আপনার নাম, ঠিকানা, মোবাইল নাম্বার, লিখে অর্ডার কনফার্ম করুন বাটনে ক্লিক করুন</p>	
										<div class="form-field">
						<div class="form-group mb-3">
							
							<input class="form-control" placeholder="আপনার নাম" name="name" type="text">
						</div>
						<div class="form-group mb-3">
							
							<textarea class="form-control"  rows="2" placeholder="আপনার ঠিকানা" name="address" cols="50"></textarea>
						</div>
						<div class="form-group mb-3">
							
							<input class="form-control" placeholder="আপনার মোবাইল" name="phone" type="text">
						</div>
						<div class="form-group mb-3">
                ...
                <option value="2">ঢাকার বাহিরে</option>
						...
						<input class="btn btn-success btn-block w-100 mb-3" type="submit" value="অর্ডার কনফার্ম করুন">
					</div>
				</div>
			</div>
		</div>
		<div class="col-sm-12 col-md-12 col-lg-6">
			...
			<table class="table">
				...
				<tbody>
				  	<tr data-id="108">
						<td><img width="50" class="media-object" src="{{asset('uploads/product/'.$product->image)}}" alt="#"></td>
					  <td class="">
						{{$product->title}} <br>
						{{$product->qty}}x৳{{$product->price}}.00
					  </td>
					  <td class="">
						<div class="d-flex quantity-group">
              
              <div class="input-group text-center quantity mb-3" style="width:120px;">
                <button class="input-group-text decrement-btn   changeQuantityBtn">-</button>
                <input type="text" name="quantity" min="1" value="1" class="form-control qty-input">
                <button class="input-group-text increment-btn   changeQuantityBtn">+</button>
            </div>
							
						</div>
						</td>
					  <td class="text-right">৳950</td>
					  <td class=""><button type="button" class="bt_main  remove-from-cart"><svg class="svg-inline--fa fa-trash" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M135.2 17.69C140.6 6.848 151.7 0 163.8 0H284.2C296.3 0 307.4 6.848 312.8 17.69L320 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H128L135.2 17.69zM394.8 466.1C393.2 492.3 372.3 512 346.9 512H101.1C75.75 512 54.77 492.3 53.19 466.1L31.1 128H416L394.8 466.1z"></path></svg><!-- <i class="fa fa-trash"></i> Font Awesome fontawesome.com --></button></td>
					  </tr>
					  				  				  				</tbody>
			  </table>
		  <div class="table shopping-cart-cart">
			<table class="table">
			  <tbody>
				<tr class="head-table">
				...
				<tr>
				  ...
				  <td class="text-right">
						৳ 
						<input id="sub_total" name="sub_total" type="hidden" value="950">
					</td>
				</tr>
				...
				<tr>
				  ...
				  <td class="text-right">
						৳ <span id="shipping_amount_d">60.00</span>
						<input id="shipping_amount" name="shipping_amount" type="hidden" value="60.00">
					</td>
				</tr>
				...
				<tr>
				  <td>Total</td>
				  <td class="text-right">
						৳ <span id="total_amount">1010</span>
						<input id="amount" name="amount" type="hidden" value="1010">
					</td>
				</tr>
				<tr>
				  <td colspan="2">
					<input id="cash_on_delevery" checked="checked" name="payment_method" type="radio" value="cash_on_delevery">
					<label for="payment_method">Cash on delevery</label>
					</td>
				</tr>
			  </tbody>
			</table>
    ...
    <script>
      $(document).ready(function() {
          $('#location').change(function() {
              ...
              // Make an AJAX request to fetch the product price based on productId
              $.ajax({
